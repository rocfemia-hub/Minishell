...
SRC = mix/list.c mix/main.c mix/error.c mix/free.c\
      ...
      parser/token.c parser/split_mini.c parser/quotes.c parser/struct.c parser/expander_cmd.c parser/expander_args.c parser/aux_expander.c parser/utils_expander.c parser/redirects.c\
